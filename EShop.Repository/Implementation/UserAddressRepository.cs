...
namespace EShop.Repository.Implementation
{
    public class UserAddressRepository : Repository<UserAddress, UserAddressViewModel, EShopContext>, IUserAddressRepository
    {
        ...
        public async Task<Result<PaginatedViewModel<UserAddressViewModel>>> GetPaginatedResult(string? title = null, int take = 10, int skip = 0)
        {
            var result = new Result<PaginatedViewModel<UserAddressViewModel>> ();
            ...
            try
            {
                ...
                if(r.Status == TS.Status.Success) {
                    result.Data = new PaginatedViewModel<UserAddressViewModel>
                    {
                        Data = r.Data,
