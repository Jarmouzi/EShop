...
namespace EShop.Repository.Implementation
{
    public class Product_GroupRepository : Repository<Product_Group, Product_GroupViewModel, EShopContext>, IProduct_GroupRepository
    {
        ...
        public async Task<Result<PaginatedViewModel<Product_GroupViewModel>>> GetPaginatedResult(string? title = null, int take = 10, int skip = 0)
        {
            var result = new Result<PaginatedViewModel<Product_GroupViewModel>> ();
            ...
            try
            {
                ...
                if(r.Status == TS.Status.Success) {
                    result.Data = new PaginatedViewModel<Product_GroupViewModel>
                    {
                        Data = r.Data,
