...
namespace EShop.Repository.Implementation
{
    public class FeatureValueRepository : Repository<FeatureValue, FeatureValueViewModel, EShopContext>, IFeatureValueRepository
    {
        ...
        public async Task<PaginatedViewModel<FeatureValueViewModel>> GetPaginatedResult(string? title = null, int take = 10, int skip = 0)
        {
            try
            {
                ...
                return new PaginatedViewModel<FeatureValueViewModel>
                {
                    Data = r,
