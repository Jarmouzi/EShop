...
namespace EShop.Repository.Implementation
{
    public class ProductVariantRepository : Repository<ProductVariant, ProductVariantViewModel, EShopContext>, IProductVariantRepository
    {
        ...
        public async Task<Result<PaginatedViewModel<ProductVariantViewModel>>> GetPaginatedResult(string? title = null, int take = 10, int skip = 0)
        {
            var result = new Result<PaginatedViewModel<ProductVariantViewModel>> ();
            ...
            try
            {
                ...
                if(r.Status == TS.Status.Success) {
                    result.Data = new PaginatedViewModel<ProductVariantViewModel>
                    {
                        Data = r.Data,
