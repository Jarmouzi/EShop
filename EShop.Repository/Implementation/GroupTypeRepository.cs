...
{
    public class GroupTypeRepository : Repository<GroupType, GroupTypeViewModel, EShopContext>, IGroupTypeRepository
    {
        public GroupTypeRepository(IUnitOfWork<EShopContext> unitOfWork, IMapper mappingEngine) : base(unitOfWork, mappingEngine)
        {
        }
