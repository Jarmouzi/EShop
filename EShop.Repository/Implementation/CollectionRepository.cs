...
namespace EShop.Repository.Implementation
{
    public class CollectionRepository : Repository<Collection, CollectionViewModel, EShopContext>, ICollectionRepository
    {
        ...
        public async Task<Result<PaginatedViewModel<CollectionViewModel>>> GetPaginatedResult(string? title = null, int take = 10, int skip = 0)
        {
            var result = new Result<PaginatedViewModel<CollectionViewModel>> ();
            ...
            try
            {
                ...
                if(r.Status == TS.Status.Success) {
                    result.Data = new PaginatedViewModel<CollectionViewModel>
                    {
                        Data = r.Data,
