...
namespace EShop.Web.API.Controllers
{
    ...
    public class RegionController : ControllerBase
    {
        ...
        //[HttpPost("Add")]
        //public async Task<IActionResult> Insert(RegionViewModel model)
        //{
        //    try
        //    {
        //        var result = await _RegionRepository.AddAsync(model);
		//
		...
		//
        //[HttpPut("Update")]
        //public async Task<IActionResult> Update(RegionViewModel model)
        //{
        //    try
        //    {
        //        var result = await _RegionRepository.UpdateAsync(model);
		//
        //        return Ok( new { Data = result.Data, Message = result.Message, Status = result.Status });
        //    }
        //    catch (Exception ex)
        ...
        public async Task<IActionResult> GetAll(string? json = null)
        {
            try
            {
                var result = await _RegionRepository.GetProcedureAsync("Region_Json", json);
