    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<PartialViewResult> OnGetFormPartial(Int64? id)
        {
            try
            {
                ...
                {
                    var page = await _pageRepository.GetByIdAsync(id.Value);
                    return new PartialViewResult
                    {
                        ViewName = "_PageForm",
        ...
        public async Task<JsonResult> OnGetCreateOrEditAsync(Int64? id)
        {
            try
            {
                ...
                {
                    var thisPage = await _pageRepository.GetByIdAsync(id.Value);
        ...
        public async Task<JsonResult> OnPostCreateOrEditAsync(Int64? id, PageViewModel page)
        {
            var html = "";
            try
            {
