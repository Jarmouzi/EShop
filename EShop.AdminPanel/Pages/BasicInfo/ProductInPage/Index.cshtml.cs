    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<PartialViewResult> OnGetFormPartial(Guid id)
        {
            try
            {
                ...
                {
                    var productinpage = await _productinpageRepository.GetByIdAsync(id);
                    return new PartialViewResult
                    {
                        ViewName = "_ProductInPageForm",
        ...
        public async Task<JsonResult> OnGetCreateOrEditAsync(Guid id)
        {
            try
            {
                ...
                {
                    var thisProductInPage = await _productinpageRepository.GetByIdAsync(id);
        ...
        public async Task<JsonResult> OnPostCreateOrEditAsync(Guid? id, ProductInPageViewModel productinpage)
        {
            var html = "";
            try
            {
